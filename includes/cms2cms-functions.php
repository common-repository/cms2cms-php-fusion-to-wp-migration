...
/**
 * Class CmsPluginFunctionsPhpFusion
 */
class CmsPluginFunctionsPhpFusion
{
    ...
    private $jsConfig = '{
        ...
        "wp_feedback"  : "//wordpress.org/support/plugin/cms2cms-php-fusion-to-wp-migration/reviews",
    ...
    {
        $cms2cms_phpfusion_access_login = get_option('cms2cms-phpfusion-login');
        $cms2cms_phpfusion_access_key   = get_option('cms2cms-phpfusion-key');

        return array(
            'email'     => $cms2cms_phpfusion_access_login,
            'accessKey' => $cms2cms_phpfusion_access_key
        );
    }
    ...
    public function isActivated()
    {
        ...
        return ($cms2cms_phpfusion_access_key != false);
    }
    ...
    public function getOptions()
    {
        ...
        $login = get_option('cms2cms-phpfusion-login');
    ...
    public function saveOptions()
    {
        ...
        if ( $key && $login ) {
            ...
            add_option('cms2cms-phpfusion-key', $key);

            delete_option('cms2cms-phpfusion-login');
            add_option('cms2cms-phpfusion-login', $login);

            delete_option('cms2cms-phpfusion-depth');
            add_option('cms2cms-phpfusion-depth', $bridge_depth);
    ...
    {
        return $this->__('Php-Fusion', 'cms2cms-phpfusion-migration');
    }
    ...
    {
        return $this->__('WordPress', 'cms2cms-phpfusion-migration');
    }
    ...
    {
        return sprintf(
            $this->__('CMS2CMS: Automated %s to %s Migration ', 'cms2cms-phpfusion-migration'),
    ...
    {
        return sprintf(
            $this->__('%s to %s', 'cms2cms-phpfusion-migration'),
            $this->getPluginSourceName(),
            $this->getPluginTargetName()
        );
    }
    ...
    public function logOut()
    {
        if (isset($_REQUEST['_wpnonce'])) {
            ...
            if ($this->verifyFormTempKey($nonce, 'cms2cms_phpfusion_logout')
                && $_POST['cms2cms_phpfusion_logout'] == 1
            ) {
                $this->clearOptions();
            }
        }
